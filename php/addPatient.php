...
// this function validates a string to be in our format
// of YYYY-MM-DD
...
// this function determines if the entered Owner ID exists
...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    // user hit the add patient button
    if(isset($_POST['add'])){
        ...
        // checking if owner exists and date is in correct format
        if ($exists and $date) {
            ...
            //returning to previous page query
            header("location:welcome.php?error=");
            exit();
        } else {
            
            // if either field is incorrect, user is notified.
            if (!$exists) {
